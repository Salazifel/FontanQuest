...
namespace Unity.VideoHelper
{
    ...
    public class Timeline : Selectable, IDragHandler, ICanvasElement, IInitializePotentialDragHandler
    {
        ...
        private UnityEngine.UI.Image positionImage, previewImage;
        ...
        private void UpdateReferences()
        {
            if (positionRect)
            {
                positionImage = positionRect.GetComponent<UnityEngine.UI.Image>();
            ...
            if (previewRect)
            {
                previewImage = previewRect.GetComponent<UnityEngine.UI.Image>();
            }
            else
            {
                previewRect = null;
        ...
        protected void UpdateFillableVisuals(RectTransform rect, UnityEngine.UI.Image image, float value)
        {
            if (rect == null)
                return;
