...
public static class ActivityManagerPerDay
{
    public static void InitializeDailyActivities()
    {
        ...
        dayActivity1.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity2.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity3.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity5.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity7.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity9.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity11.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
        ...
        dayActivity13.AddExercise(SceneManagerStaticScript.AvailableScenes.YouTubeScene.ToString(), 5);
